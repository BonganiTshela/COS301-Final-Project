    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header">Graphical Representation</h2>
                        <p class="lead">The following is the graphical representation of the results from of the comparizon of the algorithms </p>
                    </div> 
                </div>
                <!-- /.row -->
