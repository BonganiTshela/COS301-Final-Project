        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="user/login/index.html">LogIn</a>
                    </li>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <h4 class="service-heading">Java Benchmarking</h4>
                    <p class="text-muted">Java Benchmarking.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <h4 class="service-heading">Execution Time</h4>
                ...
                <div class="col-md-4">
                    ...
                    <h4 class="service-heading">Heat Generation</h4>
                    <p class="text-muted">Heat Generation.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <h4 class="service-heading">CPU-Time</h4>
                    <p class="text-muted">CPU-time</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <h4 class="service-heading">Memory Usage</h4>
                ...
                <div class="col-md-4">
                    ...
                    <h4 class="service-heading">Power Consumption</h4>
                    <p class="text-muted">Power Consumption.</p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Benchmarking Service.</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
